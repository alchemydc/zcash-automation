...
# Tor support
echo "Install Tor from debian packages" | logger
apt update && apt -y install apt-transport-https lsb-release
DISTRIBUTION=`lsb_release -c -s`
cat <<EOF >/etc/apt/sources.list.d/tor.list
deb     https://deb.torproject.org/torproject.org $DISTRIBUTION main
deb-src https://deb.torproject.org/torproject.org $DISTRIBUTION main
EOF
# get and install initial package signing key for Torproject
wget -qO- https://deb.torproject.org/torproject.org/A3C4F0F979CAA22CDBA8F512EE8CBC9E886DDD89.asc | gpg --import
gpg --export A3C4F0F979CAA22CDBA8F512EE8CBC9E886DDD89 | apt-key add -
apt update && apt -y install tor deb.torproject.org-keyring
# echo "Starting Tor daemon" | logger
