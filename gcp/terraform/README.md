...
The vote validator is enabled with `vote_validator_enabled = true`. It now runs on DigitalOcean; the GCE instance was decommissioned on 2026-09-16 and the setting should stay `false` here.
